...
| 早期 Source 引擎游戏截图重制 |  | 草稿 | 1.0.0 | zh-CN | 2026-06-11 | 多模态, 图像编辑, 风格转换, 游戏美术, 起源引擎, 低多边形 | 将输入照片重制为早期 Source 引擎风格的 3D 游戏截图，并保留构图、视角和场景布局。 | [source-engine-game-screenshot-redraw.prompt.md](prompts/multimodal/source-engine-game-screenshot-redraw/source-engine-game-screenshot-redraw.prompt.md) |
