...
| 图像取证式复刻生图提示词 | 草稿 | 1.0.0 | zh-CN | 2026-06-02 | 多模态, 图像分析, 图像生成, 提示词工程, 摄影, 瑕疵分析 | 以取证式视角分析参考图片的摄影缺陷、压缩痕迹和随手拍质感，并生成可复刻原图的 AI 生图提示词。 | [prompt.md](prompts/multimodal/image-forensic-reconstruction-prompt/prompt.md) |
